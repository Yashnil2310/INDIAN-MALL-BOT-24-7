...
project_dir = Path("/mnt/data/indianmallbot_with_image_handler")
project_dir.mkdir(exist_ok=True)

# Updated main.py with image receive and improved reply
main_py = """
...
# Copy uploaded NAMASTE.png
uploaded_image = "/mnt/data/NAMASTE.png"
copyfile(uploaded_image, project_dir / "NAMASTE.png")

# Create final ZIP
zip_final = "/mnt/data/indianmallbot_with_real_image.zip"
